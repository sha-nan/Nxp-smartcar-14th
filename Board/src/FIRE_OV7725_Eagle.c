...
void ov7725_eagle_port_init()
{
    ...
    dma_portx2buff_init(CAMERA_DMA_CH, (void *)&PTD_B0_IN, (void *)ov7725_eagle_img_buff, PTC12, DMA_BYTE1, CAMERA_DMA_NUM, DADDR_KEEPON);
    ...
    port_init(PTC12, ALT1 | DMA_FALLING | PULLUP );         //PCLK
...
{
    //寄存器，寄存器值次
    {OV7725_COM4         , 0xC1},  //150:0xc1 112:0x81 75：0x41 50:0xc1
    {OV7725_CLKRC        , 0x00},      //0x00     0x00     0x00    0x00
    {OV7725_COM2         , 0x03},
    {OV7725_COM3         , 0xD0},
    {OV7725_COM7         , 0x40},
    {OV7725_HSTART       , 0x3F},
