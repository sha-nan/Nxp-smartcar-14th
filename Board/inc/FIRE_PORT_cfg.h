...
#define FTM3_CH0    PTE5        //PTD0(ALT4)、PTE5(ALT6)            PTA3不要用（与Jtag、SWD冲突）
#define FTM3_CH1    PTE6        //PTD1(ALT4)、PTE6(ALT6)
#define FTM3_CH2    PTE7        //PTD2(ALT4)、PTE7(ALT6)
#define FTM3_CH3    PTE8        //PTD3(ALT4)、PTE8(ALT6)
#define FTM3_CH4    PTE9        //PTC8(ALT3)、PTE9(ALT6)
#define FTM3_CH5    PTE10        //PTC9(ALT3)、PTE10(ALT6)        PTA0不要用（与Jtag、SWD冲突）
#define FTM3_CH6    PTE11        //PTC10(ALT3)、PTE11(ALT6)       PTA1不要用（与Jtag冲突）
#define FTM3_CH7    PTE12        //PTC11(ALT3)、PTE12(ALT6)  
/**********************************  I2C   ***************************************/
...
#define SPI1_PCS3   PTE6        // PTE6、                   全部都是 ALT2                  全部都是 ALT2
